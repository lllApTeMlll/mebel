...
! function(a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        function e() {
            ...
            var d = la.offset().left + la.outerWidth() / 2,
                e = la.offset().top + la.outerHeight();
        ...
        function i() {
            ...
            if (ya)
                for (c = 0; c < ya.length; c++) e.indexOf(ya[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(ya[c])]);
            ya = d
        }
        ...
        function m(c) {
            if (na && la) {
                ...
                if (!d) return !1;
                var e = na.data("start-x"),
                    f = d - e,
                    g = na.data("start-width");
            ...
            g.onload = function() {
                ...
                if (e) {
                    ...
                    if ("undefined" != typeof d)
                        for (g in d) "link" != g && c.attr("data-" + g, d[g]);
        ...
        function C(c, d, e) {
            ...
            if (d && "undefined" != typeof d)
                for (f in d) "link" != f && (g += " data-" + f + '="' + d[f] + '"');
        ...
        function K() {
            ...
            var d = la.offset().left + la.width() / 2,
                e = la.offset().top + la.height();
        ...
        function O() {
            ...
            c || (c = P()), r(), b.popups.refresh("image.size"), b.popups.setContainer("image.size", a(b.opts.scrollableContainer));
            var d = la.offset().left + la.width() / 2,
                e = la.offset().top + la.height();
            b.popups.show("image.size", d, e, la.outerHeight())
        }
        ...
        function R(a) {
            ...
            if (la || b.opts.toolbarInline) la && (d = la.offset().top + la.outerHeight());
            else {
