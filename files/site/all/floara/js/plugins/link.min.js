...
! function(a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        linkText: !0
    }), a.FroalaEditor.PLUGINS.link = function(b) {
        function c() {
        ...
        function d() {
            ...
            if (a) "A" == a.get(0).parentNode.tagName && c.push(a.get(0).parentNode);
                ...
                if (b.window.getSelection) {
                    var h = b.window.getSelection();
                    if (h.getRangeAt && h.rangeCount) {
                        g = b.document.createRange();
                ...
                } else if (b.document.selection && "Control" != b.document.selection.type)
                    if (d = b.document.selection.createRange(), e = d.parentElement(), "a" == e.nodeName.toLowerCase()) c.push(e);
                    else {
                        f = e.getElementsByTagName("a"), g = b.document.body.createTextRange();
        ...
        function h() {
            ...
            return b.$wp && b.$wp.on("scroll.link-edit", function() {
                c() && b.popups.isVisible("link.edit") && f(c())
            }), b.events.on("destroy", function() {
                b.$wp && b.$wp.off("scroll.link-edit")
            }), e
        }
        ...
        function l() {
            var a = "";
            b.opts.linkInsertButtons.length >= 1 && (a = '<div class="fr-buttons">' + b.button.buildList(b.opts.linkInsertButtons) + "</div>");
            var d = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10" height="10" viewBox="0 0 32 32"><path d="M27 4l-15 15-7-7-5 5 12 12 20-20z" fill="#FFF"></path></svg>',
                e = "",
                f = 0;
            e = '<div class="fr-link-insert-layer fr-layer fr-active" id="fr-link-insert-layer-' + b.id + '">', e += '<div class="fr-input-line"><input name="href" type="text" class="fr-link-attr" placeholder="URL" tabIndex="' + ++f + '"></div>', b.opts.linkText && (e += '<div class="fr-input-line"><input name="text" type="text" class="fr-link-attr" placeholder="' + b.language.translate("Text") + '" tabIndex="' + ++f + '"></div>');
            for (var g in b.opts.linkAttributes) {
                var h = b.opts.linkAttributes[g];
                e += '<div class="fr-input-line"><input name="' + g + '" type="text" class="fr-link-attr" placeholder="' + b.language.translate(h) + '" tabIndex="' + ++f + '"></div>'
            }
            b.opts.linkAlwaysBlank || (e += '<div class="fr-checkbox-line"><span class="fr-checkbox"><input name="target" class="fr-link-attr" data-checked="_blank" type="checkbox" id="fr-link-target-' + b.id + '" tabIndex="' + ++f + '"><span>' + d + '</span></span><label for="fr-link-target-' + b.id + '">' + b.language.translate("Open in new tab") + "</label></div>"), e += '<div class="fr-action-buttons"><button class="fr-command fr-submit" data-cmd="linkInsert" href="#" tabIndex="' + ++f + '" type="button">' + b.language.translate("Insert") + "</button></div></div>";
            var k = {
                    buttons: a,
                    input_layer: e
                },
                l = b.popups.create("link.insert", k);
            return b.popups.onRefresh("link.insert", j), b.popups.onHide("link.insert", i), b.$wp && b.$wp.on("scroll.link-insert", function() {
                var a = b.image ? b.image.get() : null;
                a && b.popups.isVisible("link.insert") && u(), c && b.popups.isVisible("link.insert") && s()
            }), b.events.on("destroy", function() {
                b.$wp && b.$wp.off("scroll.link-insert")
            }), l
        }
        ...
        function n() {
            b.events.on("keyup", function(b) {
                b.which != a.FroalaEditor.KEYCODE.ESC && e(b)
        ...
        function p() {
            ...
            var k = a(b.original_window).scrollTop();
            r(h, i, j), a(b.original_window).scrollTop(k)
        }
        ...
        function r(f, g, h) {
            ...
            if (0 === f.indexOf("tel:") || 0 === f.indexOf("sms:") || 0 === f.indexOf("mailto:") || 0 === f.indexOf("notes:") || 0 === f.indexOf("data:image") || "" === b.opts.linkAutoPrefix || /^((https?:|ftps?:|http?:)\/\/|(\/))/.test(f) || (f = b.opts.linkAutoPrefix + f), f = b.helpers.sanitizeURL(f), b.opts.linkAlwaysBlank && (h.target = "_blank"), b.opts.linkAlwaysNoFollow && (h.rel = "nofollow"), g = g || "", f === b.opts.linkAutoPrefix) {
            ...
            if (n) {
                ...
                m.attr("href", f), g.length > 0 && m.text() != g && !i && m.text(g), i || m.prepend(a.FroalaEditor.START_MARKER).append(a.FroalaEditor.END_MARKER), m.attr(h), i || b.selection.restore()
            } else {
                i ? i.wrap('<a href="' + f + '"></a>') : (b.document.execCommand("unlink", !1, !1), b.selection.isCollapsed() ? (g = 0 === g.length ? j : g, b.html.insert('<a href="' + f + '">' + a.FroalaEditor.START_MARKER + g + a.FroalaEditor.END_MARKER + "</a>"), b.selection.restore()) : g.length > 0 && g != b.selection.text() ? (b.selection.remove(), b.html.insert('<a href="' + f + '">' + a.FroalaEditor.START_MARKER + g + a.FroalaEditor.END_MARKER + "</a>"), b.selection.restore()) : (q(), b.document.execCommand("createLink", !1, f)));
                for (var r = d(), s = 0; s < r.length; s++) m = a(r[s]), m.attr(h), m.removeAttr("_moz_dirty");
                1 == r.length && b.$wp && !i && (a(r[0]).prepend(a.FroalaEditor.START_MARKER).append(a.FroalaEditor.END_MARKER), b.selection.restore())
            }
    ...
    }, a.FroalaEditor.DefineIcon("insertLink", {
        NAME: "link"
    }), a.FroalaEditor.RegisterShortcut(75, "insertLink"), a.FroalaEditor.RegisterCommand("insertLink", {
        title: "Insert Link",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "link"
    }), a.FroalaEditor.DefineIcon("linkOpen", {
        NAME: "external-link"
    }), a.FroalaEditor.RegisterCommand("linkOpen", {
        title: "Open Link",
        undo: !1,
        refresh: function(a) {
            var b = this.link.get();
        ...
        callback: function() {
            var a = this.link.get();
            a && this.original_window.open(a.href)
        }
    }), a.FroalaEditor.DefineIcon("linkEdit", {
        NAME: "edit"
    }), a.FroalaEditor.RegisterCommand("linkEdit", {
        title: "Edit Link",
        undo: !1,
    ...
    }), a.FroalaEditor.DefineIcon("linkRemove", {
        NAME: "unlink"
    }), a.FroalaEditor.RegisterCommand("linkRemove", {
        title: "Unlink",
        callback: function() {
            this.link.remove()
        },
    ...
    }), a.FroalaEditor.DefineIcon("linkBack", {
        NAME: "arrow-left"
    }), a.FroalaEditor.RegisterCommand("linkBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), a.FroalaEditor.DefineIcon("linkList", {
        NAME: "search"
    }), a.FroalaEditor.RegisterCommand("linkList", {
        title: "Choose Link",
        type: "dropdown",
        focus: !1,
        undo: !1,
    ...
    }), a.FroalaEditor.RegisterCommand("linkInsert", {
        focus: !1,
        refreshAfterCallback: !1,
        callback: function() {
    ...
    }), a.FroalaEditor.DefineIcon("imageLink", {
        NAME: "link"
    }), a.FroalaEditor.RegisterCommand("imageLink", {
        title: "Insert Link",
        undo: !1,
        focus: !1,
        callback: function() {
    ...
    }), a.FroalaEditor.DefineIcon("linkStyle", {
        NAME: "magic"
    }), a.FroalaEditor.RegisterCommand("linkStyle", {
        title: "Style",
        type: "dropdown",
        html: function() {
