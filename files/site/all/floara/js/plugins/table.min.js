...
! function(a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        tableStyles: {
            //"cart-description-table": "Стиль таблиц",
        ...
        function m(c, d) {
            var e, f, g = '<div class="cart-description-table iner"  style="width:70%"><table style="width: 100%;"><tbody>',
                h = 100 / d;
            for (e = 0; c > e; e++) {
                for (g += "<tr>", f = 0; d > f; f++) g += '<td style="width: ' + h.toFixed(4) + '%;">', 0 === e && 0 === f && (g += a.FroalaEditor.MARKERS), g += "<br></td>";
                g += "</tr>"
            }
            g += "</tbody></table></div>", b.html.insert(g), b.selection.restore()
        }
                        ...
                        for (d = 0; d < g.length; d++)
                            if (0 === d || g[d][e] != g[d - 1][e])
                                if (f = a(g[d][e]), parseInt(f.attr("colspan"), 10) > 1) {
                                    ...
                                    1 == k ? f.removeAttr("colspan") : f.attr("colspan", k), f.css("width", ((f.data("old-width") - Z(e, g)) * j / i).toFixed(4) + "%"), f.removeData("old-width")
                                } else {
        ...
        function L(c) {
            if (b.$el.find(".fr-selected-cell").length > 0 && !c.shiftKey && (E(), b.$el.removeClass("fr-no-selection"), b.edit.on()), 1 == c.which) {
                ...
                var d = K(c);
                if (d) {
                    b.popups.hide("table.edit"), c.stopPropagation(), b.events.trigger("image.hideResizer"), b.events.trigger("video.hideResizer"), ha = !0;
                    var e = d.tagName.toLowerCase();
                    c.shiftKey && b.$el.find(e + ".fr-selected-cell").length > 0 ? a(b.$el.find(e + ".fr-selected-cell").closest("table")).is(a(d).closest("table")) ? J(ja, d) : F() : ((b.keys.ctrlKey(c) || c.shiftKey) && F(), ja = d, J(ja, ja))
                }
            }
        }
        ...
        function M(c) {
            if (1 == c.which) {
                ...
                if (la) {
                    la = !1, fa.removeClass("fr-moving"), b.$el.removeClass("fr-no-selection"), b.edit.on();
                    var f = parseFloat(fa.css("left")) + b.opts.tableResizerOffset;
                    b.opts.iframe && (f -= b.$iframe.offset().left), fa.data("release-position", f), fa.removeData("max-left"), fa.removeData("max-right"), Y(c), Q()
                }
            }
        }
        ...
        function N(c) {
            if (ha === !0) {
                ...
                if (d.closest("table").is(b.$el.find(".fr-selected-cell").closest("table"))) {
                    if ("TD" == c.currentTarget.tagName && 0 === b.$el.find("th.fr-selected-cell").length) return void J(ja, c.currentTarget);
                    if ("TH" == c.currentTarget.tagName && 0 === b.$el.find("td.fr-selected-cell").length) return void J(ja, c.currentTarget)
                }
                F()
            }
        }
        ...
        function P() {
            fa = a('<div class="fr-table-resizer"><div></div></div>'), b.$wp.append(fa), fa.on("mousedown", function() {
                return la = !0, fa.addClass("fr-moving"), E(), F(), fa.find("div").css("opacity", 1), !1
            }), fa.on("mousemove", function(a) {
                la && (b.opts.iframe && (a.pageX -= b.$iframe.offset().left), _(a))
            }), b.events.on("destroy", function() {
                fa.off("mousedown"), fa.html("").removeData().remove()
            }, !0)
        }

        function Q() {
            fa.find("div").css("opacity", 0), fa.css("top", 0), fa.css("left", 0), fa.css("height", 0), fa.find("div").css("height", 0), fa.hide()
        }

        function R() {
            ga.removeClass("fr-visible").css("left", "-9999px")
        }

        function S(c, d) {
            var e = a(d),
                f = e.closest("table");
            if (d && "TD" != d.tagName && "TH" != d.tagName && (e.closest("td").length > 0 ? d = e.closest("td") : e.closest("th").length > 0 && (d = e.closest("th"))), !d || "TD" != d.tagName && "TH" != d.tagName) e.get(0) != fa.get(0) && e.parent().get(0) != fa.get(0) && Q();
            else {
                ...
                if (Math.abs(c.pageX - g) <= b.opts.tableResizerOffset || Math.abs(h - c.pageX) <= b.opts.tableResizerOffset) {
                    ...
                    if (o.col > 0 && c.pageX - g <= b.opts.tableResizerOffset) {
                        ...
                        l = 1 == (parseInt(s.attr("colspan"), 10) || 1) ? s.offset().left - 1 + b.opts.tableResizingLimit : g - Z(o.col - 1, n) + b.opts.tableResizingLimit, m = 1 == (parseInt(e.attr("colspan"), 10) || 1) ? g + e.outerWidth() - b.opts.tableResizingLimit : g + Z(o.col, n) - b.opts.tableResizingLimit, i = o.col - 1, j = o.col
                    } else if (h - c.pageX <= b.opts.tableResizerOffset)
                        if (k = h, p.col < n[p.row].length && n[p.row][p.col + 1]) {
                            var t = a(n[p.row][p.col + 1]);
                            l = 1 == (parseInt(e.attr("colspan"), 10) || 1) ? g + b.opts.tableResizingLimit : h - Z(p.col, n) + b.opts.tableResizingLimit, m = 1 == (parseInt(t.attr("colspan"), 10) || 1) ? h + t.outerWidth() - b.opts.tableResizingLimit : h + Z(o.col + 1, n) - b.opts.tableResizingLimit, i = p.col, j = p.col + 1
                        } else {
                            i = p.col, j = null;
                            var u = f.parent();
                            l = f.offset().left - 1 + n[0].length * b.opts.tableResizingLimit, m = u.offset().left - 1 + u.width() + parseFloat(u.css("padding-left"))
                        }
                    fa.data("table", f), fa.data("first", i), fa.data("second", j);
                    var v = k - b.window.pageXOffset - b.opts.tableResizerOffset,
                        w = q - b.window.pageYOffset;
                    b.opts.iframe && (v += b.$iframe.offset().left - a(b.original_window).scrollLeft(), w += b.$iframe.offset().top - a(b.original_window).scrollTop(), l += b.$iframe.offset().left, m += b.$iframe.offset().left), fa.data("max-left", l), fa.data("max-right", m), fa.data("origin", k - b.window.pageXOffset), fa.css("top", w), fa.css("left", v), fa.css("height", r), fa.find("div").css("height", r), fa.css("padding-left", b.opts.tableResizerOffset), fa.css("padding-right", b.opts.tableResizerOffset), fa.show()
                } else Q()
            }
        }
        ...
        function T(c, d) {
            ...
            f.find("th, td").each(function() {
                var c = a(this);
                return c.offset().left <= g && g < c.offset().left + c.outerWidth() / 2 ? (j = parseInt(ga.find("a").css("width"), 10), ga.css("top", i + c.offset().top - b.window.pageYOffset - j - 5), ga.css("left", h + c.offset().left - b.window.pageXOffset - j / 2), ga.data("selected-cell", c), ga.data("position", "before"), ga.addClass("fr-visible"), !1) : c.offset().left + c.outerWidth() / 2 <= g && g < c.offset().left + c.outerWidth() ? (j = parseInt(ga.find("a").css("width"), 10), ga.css("top", i + c.offset().top - b.window.pageYOffset - j - 5), ga.css("left", h + c.offset().left + c.outerWidth() - b.window.pageXOffset - j / 2), ga.data("selected-cell", c), ga.data("position", "after"), ga.addClass("fr-visible"), !1) : void 0
            })
        }
        ...
        function U(c, d) {
            ...
            e.find("tr").each(function() {
                var c = a(this);
                return c.offset().top <= f && f < c.offset().top + c.outerHeight() / 2 ? (i = parseInt(ga.find("a").css("width"), 10), ga.css("top", h + c.offset().top - b.window.pageYOffset - i / 2), ga.css("left", g + c.offset().left - b.window.pageXOffset - i - 5), ga.data("selected-cell", c.find("td:first")), ga.data("position", "above"), ga.addClass("fr-visible"), !1) : c.offset().top + c.outerHeight() / 2 <= f && f < c.offset().top + c.outerHeight() ? (i = parseInt(ga.find("a").css("width"), 10), ga.css("top", h + c.offset().top + c.outerHeight() - b.window.pageYOffset - i / 2), ga.css("left", g + c.offset().left - b.window.pageXOffset - i - 5), ga.data("selected-cell", c.find("td:first")), ga.data("position", "below"), ga.addClass("fr-visible"), !1) : void 0
            })
        }
            ...
            if (0 === b.$el.find(".fr-selected-cell").length) {
                ...
                if (d && ("HTML" == d.tagName || "BODY" == d.tagName || b.node.isElement(d)))
                    for (e = 1; e <= b.opts.tableInsertHelperOffset; e++) {
                        if (f = b.document.elementFromPoint(c.pageX - b.window.pageXOffset, c.pageY - b.window.pageYOffset + e), b.$tooltip.is(f)) return !0;
                        if (f && ("TH" == f.tagName || "TD" == f.tagName || "TABLE" == f.tagName) && a(f).parents(b.$wp).length) return T(c, f.closest("table")), !0;
                        if (g = b.document.elementFromPoint(c.pageX - b.window.pageXOffset + e, c.pageY - b.window.pageYOffset), b.$tooltip.is(g)) return !0;
                        if (g && ("TH" == g.tagName || "TD" == g.tagName || "TABLE" == g.tagName) && a(g).parents(b.$wp).length) return U(c, g.closest("table")), !0
                    }
                R()
            }
        }
        ...
        function W(a) {
            ...
            (!b.popups.areVisible() || b.popups.areVisible() && b.popups.isVisible("table.edit")) && S(a, c), b.popups.areVisible() || b.$tb.hasClass("fr-inline") && b.$tb.is(":visible") || V(a, c)
        }

        function X() {
            if (la) {
                var c = fa.data("table"),
                    d = c.offset().top - b.window.pageYOffset;
                b.opts.iframe && (d += b.$iframe.offset().top - a(b.original_window).scrollTop()), fa.css("top", d)
            }
        }

        function Y() {
            var c = fa.data("origin"),
                d = fa.data("release-position");
            if (c !== d) {
                var e = fa.data("first"),
                    f = fa.data("second"),
                    g = fa.data("table"),
            ...
            fa.removeData("origin"), fa.removeData("release-position"), fa.removeData("first"), fa.removeData("second"), fa.removeData("table"), b.undo.saveStep()
        }
        ...
        function $(a, b, c) {
            var d, e = 0;
            for (d = a; b >= d; d++) e += Z(d, c);
            return e
        }

        function _(a) {
            if (b.$el.find(".fr-selected-cell").length > 1 && ia && F(), ia === !1 && ha === !1 && la === !1) ka && clearTimeout(ka), ka = setTimeout(W, 30, a);
            else if (la) {
                var c = a.pageX - b.window.pageXOffset;
                b.opts.iframe && (c += b.$iframe.offset().left);
                var d = fa.data("max-left"),
                    e = fa.data("max-right");
                c >= d && e >= c ? fa.css("left", c - b.opts.tableResizerOffset) : d > c && parseFloat(fa.css("left"), 10) > d - b.opts.tableResizerOffset ? fa.css("left", d - b.opts.tableResizerOffset) : c > e && parseFloat(fa.css("left"), 10) < e - b.opts.tableResizerOffset && fa.css("left", e - b.opts.tableResizerOffset)
            } else ia && R()
        }
        ...
        function ba(c) {
            ...
            if (d == a.FroalaEditor.KEYCODE.TAB && 0 === b.opts.tabSpaces) {
                ...
                e && (c.preventDefault(), E(), b.popups.hide("table.edit"), c.shiftKey ? e.prev().length > 0 ? aa(e.prev()) : e.closest("tr").length > 0 && e.closest("tr").prev().length > 0 ? aa(e.closest("tr").prev().find("td:last")) : e.closest("tbody").length > 0 && e.closest("table").find("thead tr").length > 0 && aa(e.closest("table").find("thead tr th:last")) : e.next().length > 0 ? aa(e.next()) : e.closest("tr").length > 0 && e.closest("tr").next().length > 0 ? aa(e.closest("tr").next().find("td:first")) : e.closest("thead").length > 0 && e.closest("table").find("tbody tr").length > 0 ? aa(e.closest("table").find("tbody tr td:first")) : (e.addClass("fr-selected-cell"), q("below"), E(), aa(e.closest("tr").next().find("td:first"))), b.selection.restore())
            }
        }

        function ca() {
            ga = a('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabindex="-1" title="' + b.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), b.$box.append(ga), b.tooltip.bind(b.$box, ".fr-insert-helper > a.fr-floating-btn"), b.events.on("destroy", function() {
                ga.html("").removeData().remove()
            }, !0), ga.on("mousemove", function(a) {
                a.stopPropagation()
            }), a(b.window).on("scroll.table" + b.id, function() {
                R()
            }), b.events.bindClick(ga, "a", function() {
                var a = ga.data("selected-cell"),
                    b = ga.data("position");
                "before" == b ? (a.addClass("fr-selected-cell"), s(b), a.removeClass("fr-selected-cell")) : "after" == b ? (a.addClass("fr-selected-cell"), s(b), a.removeClass("fr-selected-cell")) : "above" == b ? (a.addClass("fr-selected-cell"), q(b), a.removeClass("fr-selected-cell")) : "below" == b && (a.addClass("fr-selected-cell"), q(b), a.removeClass("fr-selected-cell")), R()
            }), b.events.on("destroy", function() {
                ga.off("mousemove"), a(b.window).off("scroll.table" + b.id)
            }, !0)
        }
        ...
        function da() {
            ...
            if (!b.helpers.isMobile()) {
                ia = !1, ha = !1, la = !1, P(), b.opts.tableInsertHelper && ca(), b.$el.on("mousedown.table" + b.id, L), b.popups.onShow("image.edit", function() {
                    E(), ia = !1, ha = !1
                }), b.popups.onShow("link.edit", function() {
                    E(), ia = !1, ha = !1
                }), b.events.on("commands.mousedown", function(a) {
                    a.parents(".fr-toolbar").length > 0 && E()
                }), b.$el.on("mouseenter.table" + b.id, "th, td", N), b.$window.on("mouseup.table" + b.id, M), b.opts.iframe && a(b.original_window).on("mouseup.table" + b.id, M), b.$el.on("keydown.table" + b.id, O), b.$window.on("mousemove.table" + b.id, _), a(b.original_window).on("scroll.table" + b.id, X), b.events.on("contentChanged", function() {
                ...
                }, !0), a(b.window).on("keydown.table" + b.id, d), a(b.window).on("input.table" + b.id, d), a(b.window).on("keyup.table" + b.id, d);
                var c;
                b.events.on("html.beforeGet", function() {
                    c = b.$el.find(".fr-selected-cell"), c.removeClass("fr-selected-cell")
                    ...
                    c.addClass("fr-selected-cell")
                }), b.events.on("destroy", function() {
                    b.$el.off("mousedown.table" + b.id), b.$el.off("mouseenter.table" + b.id, "th, td"), b.$window.off("mouseup.table" + b.id), b.opts.iframe && a(b.original_window).off("mouseup.table" + b.id), a(b.original_window).off("mouseup.table" + b.id), b.$el.off("keydown.table" + b.id), b.$window.off("mousemove.table" + b.id), a(b.original_window).off("scroll.table" + b.id), a(b.window).off("keydown.table" + b.id), a(b.window).off("input.table" + b.id), a(b.window).off("keyup.table" + b.id)
                }, !0)
            }
            b.events.on("keydown", ba, !0)
        }

        function ea() {
            b.$el.find(".fr-selected-cell").length > 0 ? d() : (b.popups.hide("table.insert"), b.toolbar.showInline())
        }
        var fa, ga, ha, ia, ja, ka, la;
        return {
            _init: da,
            insert: m,
            remove: n,
