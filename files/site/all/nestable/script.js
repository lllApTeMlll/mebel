...
(function ($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        dragStart: function (e)
        {
            ...
            this.dragDepthCur = this.pointEl.parents(opt.listNodeName).length;
            this.HasChild = this.pointEl.parent().find(opt.itemNodeName).length;
            if (this.HasChild > 0)
                this.dragDepthCur++;
            ...
            for (i = 0; i < items.length; i++) {
                ...
                //console.log($(items[i]).parents(this.options.listNodeName).length);
                //console.log(i);
