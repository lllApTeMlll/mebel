        ...
        onStart: function (event) {
            ...
            if ($element) {
                ...
                if (event.type == "touchstart") {
                    ...
                    console.log(options.container.offset().left);
                    console.log(options.container.offset().top);
                    dragOffsetX = event.pageX  + options.container.offset().left ;
                    dragOffsetY = event.pageY  + options.container.offset().top;
                }
